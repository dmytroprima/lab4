package functional.com;

import candy.com.Candy;
import candy.com.Chocolate_with_fillings;
import candy.com.Fruit_jelly;
import candy.com.Lollipops;
...
public class Store {
    ...
    public Store(){
        storeList.add(new Chocolate_with_fillings("korivka", 20, 15, 5, "caramel"));
        storeList.add(new Fruit_jelly("bdjilka", 15, 8, 3, "orange"));
